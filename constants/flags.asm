...
;rematch flags.
	...
	rematch_hardman_done   = 1 << 3
	rematch_topman_done    = 1 << 4
	rematch_snakeman_done  = 1 << 5
...
;regular stage clear flags.
	...
	stage_hardman_clear   = 1 << 3
	stage_topman_clear    = 1 << 4
	stage_snakeman_clear  = 1 << 5
	stage_sparkman_clear  = 1 << 6
	stage_shadowman_clear = 1 << 7
